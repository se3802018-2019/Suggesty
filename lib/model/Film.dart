...
class Film {
	...
	@override
	String toString() {
		return 'Film{title: $title, year: $year, genre: $genre, writer: $writer, language: $language, poster: $poster, imdbRating: $imdbRating}';
	}
	...
	factory Film.fromJson(Map<String, dynamic> json) => new Film(
		...
		awards: json["Awards"],
		poster: json["Poster"],
		ratings: new List<Rating>.from(json["Ratings"].map((x) => Rating.fromJson(x))),
	...
	Map<String, dynamic> toJson() => {
		...
		"Awards": awards,
		"Poster": poster,
		"Ratings": new List<dynamic>.from(ratings.map((x) => x.toJson())),
		"Metascore": metascore,
